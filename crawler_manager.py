...
if __name__ == "__main__":
    ...
    # 导入南京市规划和自然资源局部门文件爬虫
    try:
        from City import nanjing_ghj_bmwj_crawler
        manager.register_crawler(
            "南京市规划和自然资源局_部门文件",
            nanjing_ghj_bmwj_crawler.run,
            nanjing_ghj_bmwj_crawler,
        )
    except ImportError as e:
        print(f"[WARN]  导入南京市规划和自然资源局部门文件爬虫失败: {e}")
    # 导入南京市民政局部门文件爬虫
    try:
    ...
    # 导入南京市应急管理局部门文件爬虫
    try:
        from City import nanjing_yjglj_bmwj_crawler
        manager.register_crawler(
            "南京市应急管理局_部门文件",
            nanjing_yjglj_bmwj_crawler.run,
            nanjing_yjglj_bmwj_crawler,
        )
    except ImportError as e:
        print(f"[WARN]  导入南京市应急管理局部门文件爬虫失败: {e}")
    # 导入南京市财政局部门文件爬虫
    try:
    ...
    # 导入南京市审计局部门文件爬虫
    try:
        from City import nanjing_shenjiju_bmwj_crawler
        manager.register_crawler(
            "南京市审计局_部门文件",
            nanjing_shenjiju_bmwj_crawler.run,
            nanjing_shenjiju_bmwj_crawler,
        )
    except ImportError as e:
        print(f"[WARN]  导入南京市审计局部门文件爬虫失败: {e}")
    # 导入南京市教育局部门文件爬虫
    try:
    ...
    # 导入南京市人民政府外事办公室部门文件爬虫
    try:
        from City import nanjing_waiban_bmwj_crawler
        manager.register_crawler(
            "南京市人民政府外事办公室_部门文件",
            nanjing_waiban_bmwj_crawler.run,
            nanjing_waiban_bmwj_crawler,
        )
    except ImportError as e:
        print(f"[WARN]  导入南京市人民政府外事办公室部门文件爬虫失败: {e}")
    # 导入南京市人民政府国有资产监督管理委员会部门文件爬虫
    try:
        from City import nanjing_gzw_bmwj_crawler
        manager.register_crawler(
            "南京市人民政府国有资产监督管理委员会_部门文件",
            nanjing_gzw_bmwj_crawler.run,
            nanjing_gzw_bmwj_crawler,
        )
    except ImportError as e:
        print(f"[WARN]  导入南京市人民政府国有资产监督管理委员会部门文件爬虫失败: {e}")
    ...
    # 导入常州市人民政府政策文件爬虫
    try:
        from City import changzhou_szf_zcwj_crawler
        manager.register_crawler(
            "常州市人民政府_政策文件",
            changzhou_szf_zcwj_crawler.run,
            changzhou_szf_zcwj_crawler,
        )
    except ImportError as e:
    ...
    # 导入无锡市生态环境局法规文件及解读爬虫
    try:
        from City import wuxi_sthjj_fgwjjjd_crawler
        manager.register_crawler(
            "无锡市生态环境局_法规文件及解读",
            wuxi_sthjj_fgwjjjd_crawler.run,
            wuxi_sthjj_fgwjjjd_crawler,
        )
    except ImportError as e:
    ...
    # 导入无锡市粮食和物资储备局法规文件及解读爬虫
    try:
        from City import wuxi_lswz_fgwjjjd_crawler
        manager.register_crawler(
            wuxi_lswz_fgwjjjd_crawler.SOURCE_NAME,
            wuxi_lswz_fgwjjjd_crawler.run,
            wuxi_lswz_fgwjjjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 wuxi_lswz_fgwjjjd_crawler 爬虫失败: {exc}")

    try:
        from City import nanjing_amr_bmwj_crawler
        manager.register_crawler(
            nanjing_amr_bmwj_crawler.SOURCE_NAME,
            nanjing_amr_bmwj_crawler.run,
            nanjing_amr_bmwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 nanjing_amr_bmwj_crawler 爬虫失败: {exc}")
    try:
        from City import nanjing_tyj_bmwj_crawler
        manager.register_crawler(
            nanjing_tyj_bmwj_crawler.SOURCE_NAME,
            nanjing_tyj_bmwj_crawler.run,
            nanjing_tyj_bmwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 nanjing_tyj_bmwj_crawler 爬虫失败: {exc}")
    try:
        from City import nanjing_tjj_bmwj_crawler
        manager.register_crawler(
            nanjing_tjj_bmwj_crawler.SOURCE_NAME,
            nanjing_tjj_bmwj_crawler.run,
            nanjing_tjj_bmwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 nanjing_tjj_bmwj_crawler 爬虫失败: {exc}")
    try:
        from City import nanjing_ybj_bmwj_crawler
        manager.register_crawler(
            nanjing_ybj_bmwj_crawler.SOURCE_NAME,
            nanjing_ybj_bmwj_crawler.run,
            nanjing_ybj_bmwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 nanjing_ybj_bmwj_crawler 爬虫失败: {exc}")
    try:
        from City import nanjing_xfj_bmwj_crawler
        manager.register_crawler(
            nanjing_xfj_bmwj_crawler.SOURCE_NAME,
            nanjing_xfj_bmwj_crawler.run,
            nanjing_xfj_bmwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 nanjing_xfj_bmwj_crawler 爬虫失败: {exc}")
    try:
        from City import nanjing_mzzjj_bmwj_crawler
        manager.register_crawler(
            nanjing_mzzjj_bmwj_crawler.SOURCE_NAME,
            nanjing_mzzjj_bmwj_crawler.run,
            nanjing_mzzjj_bmwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 nanjing_mzzjj_bmwj_crawler 爬虫失败: {exc}")
    ...
    # 导入徐州市人民政府市政府文件爬虫
    try:
        from City import xuzhou_szf_zfwj_crawler
        manager.register_crawler(
            "徐州市人民政府_市政府文件",
            xuzhou_szf_zfwj_crawler.run,
            xuzhou_szf_zfwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入徐州市人民政府市政府文件爬虫失败: {exc}")
    ...
    try:
        from City import wuxi_scjgj_fgwjjjd_crawler
        manager.register_crawler(
            wuxi_scjgj_fgwjjjd_crawler.SOURCE_NAME,
            wuxi_scjgj_fgwjjjd_crawler.run,
            wuxi_scjgj_fgwjjjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 wuxi_scjgj_fgwjjjd_crawler 爬虫失败: {exc}")
    try:
        from City import wuxi_tyj_fgwjjjd_crawler
        manager.register_crawler(
            wuxi_tyj_fgwjjjd_crawler.SOURCE_NAME,
            wuxi_tyj_fgwjjjd_crawler.run,
            wuxi_tyj_fgwjjjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 wuxi_tyj_fgwjjjd_crawler 爬虫失败: {exc}")
    try:
        from City import wuxi_tjj_fgwjjjd_crawler
        manager.register_crawler(
            wuxi_tjj_fgwjjjd_crawler.SOURCE_NAME,
            wuxi_tjj_fgwjjjd_crawler.run,
            wuxi_tjj_fgwjjjd_crawler,
        )
    except ImportError as exc:
...
try:
    ...
    try:
        from City import wuxi_gdb_fgwjjjd_crawler
        manager.register_crawler(
            wuxi_gdb_fgwjjjd_crawler.SOURCE_NAME,
            wuxi_gdb_fgwjjjd_crawler.run,
            wuxi_gdb_fgwjjjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 wuxi_gdb_fgwjjjd_crawler 爬虫失败: {exc}")
    try:
        from City import wuxi_jgglj_fgwjjjd_crawler
        manager.register_crawler(
            wuxi_jgglj_fgwjjjd_crawler.SOURCE_NAME,
            wuxi_jgglj_fgwjjjd_crawler.run,
            wuxi_jgglj_fgwjjjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入 wuxi_jgglj_fgwjjjd_crawler 爬虫失败: {exc}")
    try:
        from City import xuzhou_zfb_zfwj_crawler
        manager.register_crawler(
            xuzhou_zfb_zfwj_crawler.SOURCE_NAME,
            xuzhou_zfb_zfwj_crawler.run,
            xuzhou_zfb_zfwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] import xuzhou_zfb_zfwj_crawler failed: {exc}")

    try:
        from City import xuzhou_zfgzbg_crawler
        manager.register_crawler(
            xuzhou_zfgzbg_crawler.SOURCE_NAME,
            xuzhou_zfgzbg_crawler.run,
            xuzhou_zfgzbg_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] import xuzhou_zfgzbg_crawler failed: {exc}")

    try:
        from City import xuzhou_fgw_zcwj_crawler
        manager.register_crawler(
            xuzhou_fgw_zcwj_crawler.SOURCE_NAME,
            xuzhou_fgw_zcwj_crawler.run,
            xuzhou_fgw_zcwj_crawler,
        )
    except ImportError as exc:
    ...
    try:
        from City import xuzhou_sjj_wjjd_crawler
        manager.register_crawler(
            xuzhou_sjj_wjjd_crawler.SOURCE_NAME,
            xuzhou_sjj_wjjd_crawler.run,
            xuzhou_sjj_wjjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] import xuzhou_sjj_wjjd_crawler failed: {exc}")

    try:
        from City import xuzhou_jyj_zcwj_crawler
        manager.register_crawler(
            xuzhou_jyj_zcwj_crawler.SOURCE_NAME,
            xuzhou_jyj_zcwj_crawler.run,
            xuzhou_jyj_zcwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] import xuzhou_jyj_zcwj_crawler failed: {exc}")

    try:
        from City import changzhou_szf_wzjd_crawler
        manager.register_crawler(
            changzhou_szf_wzjd_crawler.SOURCE_NAME,
            changzhou_szf_wzjd_crawler.run,
            changzhou_szf_wzjd_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] import changzhou_szf_wzjd_crawler failed: {exc}")

    try:
        from City import changzhou_szf_zfgzbg_crawler
        manager.register_crawler(
            changzhou_szf_zfgzbg_crawler.SOURCE_NAME,
            changzhou_szf_zfgzbg_crawler.run,
            changzhou_szf_zfgzbg_crawler,
        )
    except ImportError as exc:
    ...
    try:
        ...
        manager.register_crawler(
            "徐州市民族宗教事务局_政策文件",
            xuzhou_mzzj_zcwj_crawler.run,
            xuzhou_mzzj_zcwj_crawler,
        )
    except ImportError as exc:
        print(f"[WARN] 导入徐州市民族宗教事务局政策文件爬虫失败: {exc}")
    # 导入徐州市科学技术局政策文件爬虫
    try:
    ...
    # 导入宿迁市人民政府公示公告爬虫
    try:
        from City import suqian_szf_gsgg_crawler
        manager.register_crawler(
            "宿迁市人民政府_公示公告",
            suqian_szf_gsgg_crawler.run,
            suqian_szf_gsgg_crawler,
        )
    except ImportError as exc:
