"""
徐州市人民政府_市政府办公室文件爬虫
目标栏目：https://www.xz.gov.cn/dynamic/zwgk/govInfoPubright.html?categorynum=003001004
...
TARGET_URL = "https://www.xz.gov.cn/dynamic/zwgk/govInfoPubright.html?categorynum=003001004"
SOURCE_NAME = "徐州市人民政府_市政府办公室文件"
CATEGORY = "徐州"
    ...
    try:
        while page_index < MAX_PAGES:
            ...
            for record in records:
                ...
                policy_key = (title, pub_at.isoformat(), detail_url)
            ...
            if total_records is not None and (page_index + 1) * PAGE_SIZE >= total_records:
                break
