# -*- coding: utf-8 -*-
"""连云港市自然资源和规划局_政策法规爬虫
目标栏目: https://zrzy.jiangsu.gov.cn/gtapp/nrglIndex.action?classID=2c9082b55a1b4d4f015a1c6378e00052
列表结构: 省自然资源厅信息公开平台，列表为 table 内 td.nlist(a+span 日期)，无 #initData
分页说明: 平台 AJAX 翻页接口 /TrueCMS/messageController/getMessage.do 已停用(实测404)，
          列表页服务端渲染的首页数据(首屏25条)是唯一可用数据源。
"""
import re
...
TARGET_URL = "https://zrzy.jiangsu.gov.cn/gtapp/nrglIndex.action?classID=2c9082b55a1b4d4f015a1c6378e00052"
SOURCE_NAME = "连云港市自然资源和规划局_政策法规"
CATEGORY = "连云港"
