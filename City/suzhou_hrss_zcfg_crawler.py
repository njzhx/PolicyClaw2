...
TARGET_URL = "https://hrss.suzhou.gov.cn/jsszhrss/zxfgk/zxfgk.shtml"
SOURCE_NAME = "苏州市人力资源和社会保障局_政策法规库"
CATEGORY = "苏州"

API_URL = "https://hrss.suzhou.gov.cn/szinf/interfacesWebRsjZcwjk/page"
PAGE_SIZE = 15
MAX_PAGES = 200
...
def _extract_content(session, article_url, metrics):
    try:
        ...
        element = soup.select_one("#zoomcon UCAPCONTENT") or soup.select_one("#zoomcon") or soup.select_one(".TRS_UEDITOR")
        ...
        while page_index <= MAX_PAGES:
            ...
            for record in records:
                try:
                    ...
                    pub_date_str = (record.get("fwTimeFormat") or "").strip()

                    if not title or not href:
                        metrics.invalid_item_count += 1
                        continue

                    article_url = urljoin("https://hrss.suzhou.gov.cn/", href.lstrip("/")) if href else ""
