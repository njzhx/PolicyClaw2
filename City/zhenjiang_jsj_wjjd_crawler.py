...
TARGET_URL = "http://jsj.zhenjiang.gov.cn/jsj/xxgkwjjd/xxgk_lists.shtml"
SOURCE_NAME = "镇江市住房和城乡建设局_文件解读"
CATEGORY = "镇江"

CHANNEL_URLS = [
    "http://jsj.zhenjiang.gov.cn/jsj/xxgkbmwj/xxgk_list.shtml",
    "http://jsj.zhenjiang.gov.cn/jsj/xxgkzcjd/xxgk_list.shtml",
]
