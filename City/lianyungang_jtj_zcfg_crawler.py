# -*- coding: utf-8 -*-
"""连云港市交通运输局_政策法规爬虫
目标栏目: http://jtj.lyg.gov.cn/lygjt/zcfg/zcfg.html
列表结构: 静态列表 ul.container-main-body>li(a+span 日期)，无 #initData 与分页接口
分页说明: 平台 AJAX 翻页接口 /TrueCMS/messageController/getMessage.do 已停用(实测404)，
          列表页服务端渲染的首页数据(整页5条)是唯一可用数据源。
"""
import re
...
TARGET_URL = "http://jtj.lyg.gov.cn/lygjt/zcfg/zcfg.html"
SOURCE_NAME = "连云港市交通运输局_政策法规"
CATEGORY = "连云港"
BASE_URL = "http://jtj.lyg.gov.cn"
...
LIST_ITEM_SELECTOR = "ul.container-main-body"
LIST_FIRST_ONLY = True
