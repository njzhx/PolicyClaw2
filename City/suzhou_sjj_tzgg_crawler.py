...
TARGET_URL = "https://xzspj.suzhou.gov.cn/szsxzspj/tzgg/nav_list.shtml"
SOURCE_NAME = "苏州市数据和政务服务局_通知公告"
CATEGORY = "苏州"
MAX_PAGES = 200
...
def _get_page_url(base_url, page):
    if page == 1:
        return base_url
    return re.sub(r'nav_list\.shtml$', f'nav_list_{page}.shtml', base_url)
