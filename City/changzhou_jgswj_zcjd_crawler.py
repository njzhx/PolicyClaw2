...
站点：常州市机关事务管理局 政策解读（市政府政策解读聚合栏目）
...
def _extract_content(session, article_url, metrics):
    ...
    try:
        ...
        element = soup.select_one("td#czfxfontzoom.NewsContent") or soup.select_one(
            "td.NewsContent"
        )
        if not element:
            return ""
