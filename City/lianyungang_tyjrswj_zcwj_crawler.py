# -*- coding: utf-8 -*-
"""连云港市退役军人事务局_政策文件爬虫
目标栏目: http://tyjrswj.lyg.gov.cn/tyjrswj/zcwj/zcwj.html
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接为 a[href]，日期在 span(带方括号)
分页说明: 平台 AJAX 翻页接口 /TrueCMS/messageController/getMessage.do 已停用(实测404)，
          列表页服务端渲染的首页数据(首屏53条)是唯一可用数据源。
"""
import re
...
TARGET_URL = "http://tyjrswj.lyg.gov.cn/tyjrswj/zcwj/zcwj.html"
SOURCE_NAME = "连云港市退役军人事务局_政策文件"
CATEGORY = "连云港"
BASE_URL = "http://tyjrswj.lyg.gov.cn"
...
LIST_ITEM_SELECTOR = "ul.list_page li"
