# -*- coding: utf-8 -*-
"""连云港市工信局_通知公告爬虫
目标栏目: http://gxj.lyg.gov.cn/tztg/tztg.html
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接为 a[href]，日期在 li 文本前缀
...
TARGET_URL = "http://gxj.lyg.gov.cn/tztg/tztg.html"
SOURCE_NAME = "连云港市工信局_通知公告"
CATEGORY = "连云港"
