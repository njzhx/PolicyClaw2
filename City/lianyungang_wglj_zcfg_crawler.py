# -*- coding: utf-8 -*-
"""连云港市文化广电和旅游局_政策法规爬虫
目标栏目: http://wglj.lyg.gov.cn/lygswgxj/zcfgl/zcfgl.html?id=2
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接在 a 的 onclick=name2('...')(部分为省文旅厅外链)，日期在 span
分页说明: 平台 AJAX 翻页接口 /TrueCMS/messageController/getMessage.do 已停用(实测404)，
          列表页服务端渲染的首页数据(首屏49条)是唯一可用数据源。
"""
import re
...
TARGET_URL = "http://wglj.lyg.gov.cn/lygswgxj/zcfgl/zcfgl.html?id=2"
SOURCE_NAME = "连云港市文化广电和旅游局_政策法规"
CATEGORY = "连云港"
BASE_URL = "http://wglj.lyg.gov.cn"
