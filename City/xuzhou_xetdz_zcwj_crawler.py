# -*- coding: utf-8 -*-
"""徐州经济技术开发区管理委员会_政策文件 爬虫。

列表数据通过徐州统一信息公开平台 JSON 接口获取：
POST http://xetdz.xz.gov.cn/EWB-FRONT/rest/lightfrontaction/getgovinfolist
"""
...
TARGET_URL = "http://xetdz.xz.gov.cn/dynamic/zwgk/govInfoPub.html?categorynum=003001"
SOURCE_NAME = "徐州经济技术开发区管理委员会_政策文件"
CATEGORY = "徐州"
HOST = "http://xetdz.xz.gov.cn"
CATEGORY_NUM = "003001"
