# -*- coding: utf-8 -*-
"""连云港市卫生健康委员会_政策解读爬虫
目标栏目: http://wjw.lyg.gov.cn/lygswjw/zcjd/zcjd.html
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接为 a[href](部分为微信外链)，日期在 span(带方括号)
...
TARGET_URL = "http://wjw.lyg.gov.cn/lygswjw/zcjd/zcjd.html"
SOURCE_NAME = "连云港市卫生健康委员会_政策解读"
CATEGORY = "连云港"
BASE_URL = "http://wjw.lyg.gov.cn"
...
LIST_ITEM_SELECTOR = "ul.right_news_list li"
