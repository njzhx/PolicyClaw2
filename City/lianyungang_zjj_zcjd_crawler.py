# -*- coding: utf-8 -*-
"""连云港市住房和城乡建设局_政策解读爬虫
目标栏目: http://jsj.lyg.gov.cn/lygszfj/zcjd/zcjd.html
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接为 a[href](部分为微信外链)，日期在 span
...
TARGET_URL = "http://jsj.lyg.gov.cn/lygszfj/zcjd/zcjd.html"
SOURCE_NAME = "连云港市住房和城乡建设局_政策解读"
CATEGORY = "连云港"
BASE_URL = "http://jsj.lyg.gov.cn"
