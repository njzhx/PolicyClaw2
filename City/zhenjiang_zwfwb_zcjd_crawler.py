...
TARGET_URL = "https://zwfwb.zhenjiang.gov.cn/zwfwb/xxgkzcjd/xxgk_list.shtml"
SOURCE_NAME = "镇江市数据局_政策解读"
CATEGORY = "镇江"

CHANNEL_URLS = [
    "https://zwfwb.zhenjiang.gov.cn/zwfwb/xxgkzcjd/xxgk_list.shtml",
]
