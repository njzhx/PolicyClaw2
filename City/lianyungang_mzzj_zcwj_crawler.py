# -*- coding: utf-8 -*-
"""连云港市民族宗教事务局_政策文件爬虫
目标栏目: http://mzzj.lyg.gov.cn/lygmzzj/zcwj/zcwj.html
...
TARGET_URL = "http://mzzj.lyg.gov.cn/lygmzzj/zcwj/zcwj.html"
SOURCE_NAME = "连云港市民族宗教事务局_政策文件"
CATEGORY = "连云港"
BASE_URL = "http://mzzj.lyg.gov.cn"
