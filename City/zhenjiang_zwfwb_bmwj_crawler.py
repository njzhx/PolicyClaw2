...
TARGET_URL = "https://zwfwb.zhenjiang.gov.cn/zwfwb/xxgkbmwj/xxgk_list.shtml"
SOURCE_NAME = "镇江市数据局_部门文件"
CATEGORY = "镇江"

CHANNEL_URLS = [
    "https://zwfwb.zhenjiang.gov.cn/zwfwb/xxgkbmwj/xxgk_list.shtml",
]
