...
TARGET_URL = "https://nyncj.suzhou.gov.cn/nlj/zcfg/list.shtml"
SOURCE_NAME = "苏州市农业农村局_政策法规"
CATEGORY = "苏州"
...
def scrape_data():
    ...
    for page_num in range(1, max_pages + 1):
        ...
        soup = BeautifulSoup(response.content, "html.parser")
        nodes = soup.select("div.pageList > li")
        ...
        if not page_has_target and metrics.valid_item_count > len(nodes):
            pass
        oldest_on_page = None
        for node in nodes:
            try:
