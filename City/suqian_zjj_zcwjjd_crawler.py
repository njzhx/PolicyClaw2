"""
宿迁市住房和城乡建设局_政策文件及解读爬虫
目标页面：https://zjj.suqian.gov.cn/szjj/zcfg/xxgk_list.shtml
...
TARGET_URL = "https://zjj.suqian.gov.cn/szjj/zcfg/xxgk_list.shtml"
SOURCE_NAME = "宿迁市住房和城乡建设局_政策文件及解读"
CATEGORY = "宿迁"
