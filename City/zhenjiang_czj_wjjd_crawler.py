...
TARGET_URL = "http://czj.zhenjiang.gov.cn/czj/xxgkwjjd/xxgk_lists.shtml"
SOURCE_NAME = "镇江市财政局_文件解读"
CATEGORY = "镇江"

CHANNEL_URLS = [
    "http://czj.zhenjiang.gov.cn/czj/xxgkbmwj/xxgk_list.shtml",
    "http://czj.zhenjiang.gov.cn/czj/xxgkzcjd/xxgk_list.shtml",
]
