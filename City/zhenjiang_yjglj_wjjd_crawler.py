...
TARGET_URL = "http://yjglj.zhenjiang.gov.cn/yjglj/xxgkwjjd/xxgk_lists.shtml"
SOURCE_NAME = "镇江市应急管理局_文件解读"
CATEGORY = "镇江"

CHANNEL_URLS = [
    "http://yjglj.zhenjiang.gov.cn/yjglj/xxgkbmwj/xxgk_list.shtml",
    "http://yjglj.zhenjiang.gov.cn/yjglj/xxgkzcjd/xxgk_list.shtml",
]
