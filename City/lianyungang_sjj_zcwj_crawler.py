# -*- coding: utf-8 -*-
"""连云港市数据局_政策文件爬虫
目标栏目: https://shuju.lyg.gov.cn/szwb/qtxygkdwj/qtxygkdwj.html?id=2
...
TARGET_URL = "https://shuju.lyg.gov.cn/szwb/qtxygkdwj/qtxygkdwj.html?id=2"
SOURCE_NAME = "连云港市数据局_政策文件"
CATEGORY = "连云港"
