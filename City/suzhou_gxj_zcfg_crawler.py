...
TARGET_URL = "https://gxj.suzhou.gov.cn/szeic/zcfg/common_list.shtml"
SOURCE_NAME = "苏州市工业和信息化局_政策法规"
CATEGORY = "苏州"
MAX_PAGES = 200
...
def _get_page_url(base_url, page):
    if page == 1:
        return base_url
    return re.sub(r'common_list\.shtml$', f'common_list_{page}.shtml', base_url)
...
def scrape_data():
    ...
    try:
        while page_index <= MAX_PAGES:
            try:
                page_url = _get_page_url(TARGET_URL, page_index)
