# -*- coding: utf-8 -*-
"""连云港市工信局_政策服务爬虫
目标栏目: http://gxj.lyg.gov.cn/zcfw/zcfw.html
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接为 a[href](部分为工信部外链)，日期在 li 文本前缀
分页说明: 平台 AJAX 翻页接口 /TrueCMS/messageController/getMessage.do 已停用(实测404)，
          列表页服务端渲染的首页数据(首屏22条)是唯一可用数据源。
"""
import re
...
TARGET_URL = "http://gxj.lyg.gov.cn/zcfw/zcfw.html"
SOURCE_NAME = "连云港市工信局_政策服务"
CATEGORY = "连云港"
BASE_URL = "http://gxj.lyg.gov.cn"
