"""
徐州市教育局_政策文件爬虫
目标栏目：https://jyj.xz.gov.cn/dynamic/zwgk/govInfoPub.html?categorynum=003001
列表接口：https://jyj.xz.gov.cn/EWB-FRONT/rest/lightfrontaction/getgovinfolist
"""
import json
import re
...
TARGET_URL = "https://jyj.xz.gov.cn/dynamic/zwgk/govInfoPub.html?categorynum=003001"
SOURCE_NAME = "徐州市教育局_政策文件"
CATEGORY = "徐州"
BASE_URL = "https://jyj.xz.gov.cn/"

LIST_API_URL = "https://jyj.xz.gov.cn/EWB-FRONT/rest/lightfrontaction/getgovinfolist"
SITE_GUID = "8d3e8c90-57dd-4777-960a-48602ccf745d"
CATEGORY_NUM = "003001"
    ...
    try:
        while page_index < MAX_PAGES:
            ...
            for record in records:
                ...
                categoryname_clean = _clean_title(categoryname)
                if categoryname_clean != TARGET_CATEGORY_NAME:
                    metrics.invalid_item_count += 1
                    continue
