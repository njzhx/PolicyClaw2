# -*- coding: utf-8 -*-
"""连云港市医疗保障局_政策文件爬虫
目标栏目: http://ybj.lyg.gov.cn/sylbzj/bmwj/bmwj.html?id=5
...
TARGET_URL = "http://ybj.lyg.gov.cn/sylbzj/bmwj/bmwj.html?id=5"
SOURCE_NAME = "连云港市医疗保障局_政策文件"
CATEGORY = "连云港"
BASE_URL = "http://ybj.lyg.gov.cn"
