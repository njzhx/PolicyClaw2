# -*- coding: utf-8 -*-
"""连云港市司法局_政策解读爬虫
目标栏目: http://sfj.lyg.gov.cn/lygssfxzw/zcjd/zcjd.html?id=2
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接在 a 的 onclick=name2('...')，日期在 span
分页说明: 平台 AJAX 翻页接口 /TrueCMS/messageController/getMessage.do 已停用(实测404)，
          列表页服务端渲染的首页数据(首屏24条)是唯一可用数据源。
"""
import re
...
TARGET_URL = "http://sfj.lyg.gov.cn/lygssfxzw/zcjd/zcjd.html?id=2"
SOURCE_NAME = "连云港市司法局_政策解读"
CATEGORY = "连云港"
BASE_URL = "http://sfj.lyg.gov.cn"
