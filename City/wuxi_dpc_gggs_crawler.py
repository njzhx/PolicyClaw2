...
TARGET_URL = "https://dpc.wuxi.gov.cn/gggs/index.shtml"
SOURCE_NAME = "无锡市发改委_公告公示"
CATEGORY = "无锡"
...
class _ListParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        # 公告公示使用 class="list03 list03_sp" 的ul
        if tag == "ul" and "list03" in class_name:
            self._in_list = True
        ...
        elif tag == "span" and self._in_li and "riqi" in class_name:
            self._in_date = True
    ...
    def handle_data(self, data):
        if self._in_link and not self._in_date:
...
def _get_total_pages(html):
    """从页面HTML中提取总页数"""
    # 公告公示使用 regClick_blue({"pageIndex":"1","pageCount":"19"...
