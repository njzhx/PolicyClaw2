# -*- coding: utf-8 -*-
"""连云港市人民政府外事办公室_政策法规爬虫
目标栏目: http://wb.lyg.gov.cn/swqb/zcfg/zcfg.html
列表结构: TrueCMS，列表在隐藏容器 #initData 内(ul>li)，链接为 a[href](部分为 gov.cn 外链)，日期在 span(带方括号)
...
TARGET_URL = "http://wb.lyg.gov.cn/swqb/zcfg/zcfg.html"
SOURCE_NAME = "连云港市人民政府外事办公室_政策法规"
CATEGORY = "连云港"
BASE_URL = "http://wb.lyg.gov.cn"
