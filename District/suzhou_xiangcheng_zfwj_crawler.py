...
SOURCE_NAME = "苏州市相城区_政府发文"
CATEGORY = "苏州_相城区"
PID = "5a4d1ac273b04ae3a5c1038d63ef4f7d"
...
def scrape_data():
    ...
    while page <= max_pages:
        api_url = (
            f"http://www.szxc.gov.cn/appsearch/xcapi/list"
            f"?pid={PID}&channel_id=&pageSize=15&currentPage={page}"
        )
        try:
