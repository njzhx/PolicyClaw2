"""
扬州市宝应县_政府办发文爬虫
目标栏目：https://baoying.yangzhou.gov.cn/zfxxgk/fdzdgknr/zfwj/xzfbwj/index.html
...
TARGET_URL = "https://baoying.yangzhou.gov.cn/zfxxgk/fdzdgknr/zfwj/xzfbwj/index.html"
SOURCE_NAME = "扬州市宝应县_政府办发文"
CATEGORY = "扬州_宝应县"
...
def _extract_content(session, article_url, metrics):
    try:
        ...
        media_only = False
        for selector in ('.bt-content', '.TRS_UEDITOR', '.article-content', '#UCAP-CONTENT', '.TRS_Editor', '#zoom', '.Custom_UnionStyle', '.article', '.content'):
